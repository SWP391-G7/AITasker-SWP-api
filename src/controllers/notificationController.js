/**
 * Backend module: controllers/notificationController.js
 *
 * Vai trò: Controller notification Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
