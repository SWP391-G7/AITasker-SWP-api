/**
 * Backend module: controllers/ratingController.js
 *
 * Vai trò: Controller rating Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
