/**
 * Backend module: controllers/messageController.js
 *
 * Vai trò: Controller message Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
