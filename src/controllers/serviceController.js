/**
 * Backend module: controllers/serviceController.js
 *
 * Vai trò: Controller service Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
