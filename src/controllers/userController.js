/**
 * Backend module: controllers/userController.js
 *
 * Vai trò: Controller user Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
