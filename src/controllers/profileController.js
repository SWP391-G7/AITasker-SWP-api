/**
 * Backend module: controllers/profileController.js
 *
 * Vai trò: Controller profile Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
