/**
 * Backend module: controllers/projectController.js
 *
 * Vai trò: Controller project Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
