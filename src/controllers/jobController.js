/**
 * Backend module: controllers/jobController.js
 *
 * Vai trò: Controller job Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
