/**
 * Backend module: controllers/disputeController.js
 *
 * Vai trò: Controller dispute Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
