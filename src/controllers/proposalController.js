/**
 * Backend module: controllers/proposalController.js
 *
 * Vai trò: Controller proposal Controller: tiếp nhận request đã đi qua route/middleware, kiểm tra dữ liệu đầu vào và điều phối nghiệp vụ.
